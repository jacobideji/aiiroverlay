...
- **Mapping completeness:** all 10 ASI categories have substantive playbook coverage.
  ...
  - **ASI06 Memory & Context Poisoning:** [Playbook 03](../playbooks/03-rag-knowledge-base-forensics.md) (RAG forensics), [Playbook 06](../playbooks/06-prompt-injection-workflow.md) (workflow-injection vector), [Playbook 09](../playbooks/09-output-leakage.md) (output-side response when memory carries leaked content forward), [Playbook 11](../playbooks/11-monitoring-detection.md) (detection), [Playbook 22](../playbooks/22-model-policy-drift.md) (change-event forensics when memory or retrieval configuration changes accumulate as drift), and [Playbook 23](../playbooks/23-logging-privacy.md) (the memory-hygiene discipline applied to evidence: memory snapshots are themselves payload-class evidence and require the redaction-and-tokenization discipline to be retained defensibly).
