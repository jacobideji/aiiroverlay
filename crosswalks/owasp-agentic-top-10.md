...
- **Mapping completeness:** all 10 ASI categories have substantive playbook coverage.
  ...
  - **ASI09 Human-Agent Trust Exploitation:** [Playbook 24](../playbooks/24-board-ready-scorecard.md) (governance-side trust posture) and [Playbook 17](../playbooks/17-communication-techniques.md) (incident-time trust-preservation discipline: when AI trust is broken by an incident, the 30-minute first-update SLA, the Three-Status Taxonomy, the Stakeholder Communication Matrix, the Template Library, and the Responsible Reframing discipline are the trust-rebuilding machinery that runs alongside the framework's technical response).
