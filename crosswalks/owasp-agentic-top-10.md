...
- **Mapping completeness:** all 10 ASI categories have substantive playbook coverage.
  ...
  - **ASI04 Agentic Supply Chain Compromise:** [Playbook 07](../playbooks/07-secrets-and-tokens.md) (vendor credential discipline), [Playbook 10](../playbooks/10-vendor-copilots.md) (the framework's dedicated vendor-copilot response playbook), and [Playbook 21](../playbooks/21-shadow-ai.md) (vendor-hosted shadow agents are an ASI04 surface that the discovery boundary addresses before they cause an incident).
