...
- **MANAGE 4.3 (recovery-process clause only):** *"Processes for tracking, responding to, and recovering from incidents and errors are followed and documented."* (The "incidents and errors are communicated to relevant AI actors, including affected communities" clause of MANAGE 4.3 is operationalized by [Playbook 17](../playbooks/17-communication-techniques.md) per the Communication-discipline gap note below.)
