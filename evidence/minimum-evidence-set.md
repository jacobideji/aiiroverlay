...
- **AI Logging and Privacy in a Multi-Stakeholder World** (Playbook 23): [`playbooks/23-logging-privacy.md`](../playbooks/23-logging-privacy.md) (the privacy-discipline companion to PB15: the Multi-Stakeholder Governance Matrix with Security, Privacy, Legal, and Engineering each holding a defensible interest; the Three-Layer Logging Model with Layer 1 metadata broadly retained, Layer 2 selective payload narrowly triggered by documented high-risk actions and incident windows, and Layer 3 escalation capture under legal hold; the Forensically Useful standard with the six core questions logs must answer at Layer 1 alone for typical incidents; and the redaction-and-tokenization discipline with structural preservation that retains evidence value while removing sensitive content).
