...
**SLA realism (table-stakes vs stretch):** the 30-minute target is achievable for organizations with a pre-positioned Template Library and an approval chain calibrated to the incident's stakeholder class. For organizations whose every external message routes through sequential CISO + General Counsel + Communications + CEO approvals before issuance, 30 minutes is a stretch target rather than a table-stakes commitment. Adopters in this profile should document the customer's actual approval-chain time, adopt 60 minutes as the table-stakes target with 30 minutes as the stretch, and queue the approval-chain compression as a hardening backlog item per [Playbook 18](18-post-incident-hardening.md). The framework's 30-minute target is the discipline goal; the customer's realistic target is the operational truth.
...
| **Regulator** | Per regulatory disclosure window: SEC Form 8-K Item 1.05 (4 business days from materiality determination), GDPR Article 33 (72 hours from awareness of personal-data breach), HIPAA Breach Notification Rule per 45 CFR §164.404/406/408 (60 days from discovery for individual notification at any size, HHS and media notification for 500+ affected, and HHS for under-500 may be annual), EU AI Act Article 73 (15 days for serious incidents, 2 days for death or serious irreversible harm), NY DFS 23 NYCRR Part 500.17(a) for financial-services licensees (72 hours from Cybersecurity Event determination), state breach-notification laws (varies, often immediate) | Per regulatory disclosure standard (each regulator has a specific form, content scope, and channel) | Legal drafts; Communications reviews factual claims; CISO and senior executive approve issuance |
